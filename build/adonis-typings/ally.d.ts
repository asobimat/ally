...
declare module '@ioc:Adonis/Addons/Ally' {
    ...
    import { Oauth2AccessToken, Oauth1RequestToken, Oauth1AccessToken, Oauth1ClientConfig, Oauth2ClientConfig, ApiRequestContract, RedirectRequestContract as ClientRequestContract } from '@poppinss/oauth-client';
     ...
     */
    export type ExtendDriverCallback = (ally: AllyManagerContract, mapping: string, config: any, ctx: HttpContextContract) => AllyDriverContract<Oauth2AccessToken | Oauth1AccessToken, string>;
    /**
    ...
    export interface AllyContract {
         ...
         */
        use<Provider extends keyof SocialProviders>(provider: Provider): SocialProviders[Provider]['implementation'];
        /**
    ...
    export interface AllyManagerContract {
         ...
         */
        makeMapping<Provider extends keyof SocialProviders>(ctx: HttpContextContract, mapping: keyof SocialProviders): SocialProviders[Provider]['implementation'];
        /**
         * Make instance of an unnamed mapping
         */
        makeMapping(ctx: HttpContextContract, mapping: string): AllyDriverContract<Oauth2AccessToken | Oauth1AccessToken, string>;
        /**
