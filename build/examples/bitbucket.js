...
// import { bitbucket } from '../src/Config'
...
// const CALLBACK_URL = `${BASE_URL}/bitbucket/callback`
// /**
//  * Returns the redirect url for the twitter request
//  */
// async function getRedirectUrl(): Promise<string> {
// 	const redirectRequest = new UrlBuilder(bitbucket.REDIRECT_URL)
...
// 	const requestToken = new Oauth2Request(bitbucket.ACCESS_TOKEN_URL, {
// 		clientId: CLIENT_ID,
...
// 			res.end(`<a href="${await getRedirectUrl()}">Login with bitbucket</a>`)
// 		} else {
