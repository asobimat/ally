 ...
 */
var SpotifyDriver = /** @class */ (function (_super) {
    __extends(SpotifyDriver, _super);
    function SpotifyDriver(ctx, config) {
        var _this = _super.call(this, ctx, config) || this;
        _this.config = config;
        _this.accessTokenUrl = 'https://accounts.spotify.com/api/token';
        _this.authorizeUrl = 'https://accounts.spotify.com/authorize';
        _this.userInfoUrl = 'https://api.spotify.com/v1/me';
        /**
         ...
         */
        _this.stateCookieName = 'spotify_oauth_state';
        /**
     ...
     */
    SpotifyDriver.prototype.configureRedirectRequest = function (request) {
        /**
     ...
     */
    SpotifyDriver.prototype.getAuthenticatedRequest = function (url, token) {
     ...
     */
    SpotifyDriver.prototype.getUserInfo = function (token, callback) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        request = this.getAuthenticatedRequest(this.userInfoUrl, token);
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                email: body.email,
                                avatarUrl: ((_a = body.images[0]) === null || _a === void 0 ? void 0 : _a.url) || null,
     ...
     */
    SpotifyDriver.prototype.accessDenied = function () {
     ...
     */
    SpotifyDriver.prototype.user = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var token, user;
     ...
     */
    SpotifyDriver.prototype.userFromToken = function (token, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
